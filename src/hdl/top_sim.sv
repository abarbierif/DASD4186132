module top_sim(
  input clk, 
  input clk_enable, // se trata clk_enable como una entrada para efectos de simulacion
  input pause,
  input load,
  input [15:0] in,
  output [6:0] seg,
  ...
  // clk_div y button_driver omitidos; reemplazados por entradas del testbench
